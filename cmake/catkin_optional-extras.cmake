...
# kcu : still working on it
macro(co_cpack)
  include(InstallRequiredSystemLibraries)
  if(${CATKIN_ON})
    set(CPACK_PACKAGE_NAME ${PROJECT_NAME})
    # TODO : arguments
    set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${PROJECT_NAME} debian package")
    # TODO : arguments
    ...
    set(CPACK_PACKAGE_VENDOR "utiasASRL")
    ...
    set(CPACK_PACKAGING_INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX})
    set(CPACK_PACKAGE_CONTACT "utiasASRL foo@bar.com")
  endif()
  include(CPack)
endmacro()
